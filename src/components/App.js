...
// Import songs
import song1 from "../static/songs/Bhool Bhulaiyaa 2 Title Track.mp3"
import song2 from "../static/songs/Mehbooba Main Teri Mehbooba.mp3"
import song3 from "../static/songs/Meri Zindagi Hai Tu.mp3"
import song4 from "../static/songs/Raatan Lambiyan.mp3"
import song5 from "../static/songs/Srivalli.mp3"

// Import the cover image of the song
import song1Cover from "../static/Bhool Bhulaiyaa 2.jpg";
import song2Cover from "../static/Mehbooba main teri mehbooba.jpg";
import song3Cover from "../static/Mere Zindagi hai tu.jpg";
import song4Cover from "../static/Raatan-Lambiyan.jpg";
import song5Cover from "../static/Srivali.jpg";

// Import the background images
import Background1 from "../static/Background 1.jpg"
import Background2 from "../static/Background 2.jpg"
import Background3 from "../static/Background 3.jpg"
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songImgItemsUrl: [song1Cover, song2Cover, song3Cover,song4Cover,song5Cover,],  //song images list
      wallpaperItems: [Background1, Background2, Background3], //wallpapers
      songItems: [" Bhool Bhulaiyaa-2 ", "Mehbooba main teri mehbooba ", "Meri Zindagi Hai Tu","Raatan-Lambiyan","Srivali"], //song names
      ...
      theme: "#697689", //current body theme
      audio: new Audio(song1), //current audio file
      songImgUrl: song1Cover, //current song img for now playing
      wheelColor: "orange", //current wheel color
